...
class Bounded(Validator):
    ...
    def __init__(
        ...
        assert lower_bound is not None or upper_bound is not None, "Do not use this object to create an unbounded " \
                                                                   "validator. "
    ...
    def validate(self, value):
        """This method implicitly validates isinstance(value, (float, int)) because it will throw a TypeError on
        comparison """
